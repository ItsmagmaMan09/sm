...
public class Modelsculkfox<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sculkfox"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(-5.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
		...
		PartDefinition body_rotation = body
				.addOrReplaceChild("body_rotation",
						CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -5.0F, -3.0F, 6.0F, 11.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 9.0F, -0.5F, 1.5708F, 0.0F, 0.0F));

		PartDefinition left2 = partdefinition.addOrReplaceChild("left2", CubeListBuilder.create().texOffs(8, 29).addBox(
				-8.001F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 17.5F, 7.0F));

		PartDefinition right = partdefinition.addOrReplaceChild("right", CubeListBuilder.create().texOffs(0, 29).addBox(
				0.001F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 17.5F, 7.0F));

		PartDefinition left = partdefinition.addOrReplaceChild("left", CubeListBuilder.create().texOffs(8, 29).addBox(
				-8.001F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 17.5F, 0.0F));

		PartDefinition right2 = partdefinition.addOrReplaceChild("right2", CubeListBuilder.create().texOffs(0, 29)
				.addBox(0.001F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, 17.5F, 0.0F));

		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(),
				PartPose.offset(4.0F, 13.0F, 10.0F));

		PartDefinition tail_rotation = tail
				.addOrReplaceChild("tail_rotation",
						CubeListBuilder.create().texOffs(22, 12).addBox(-2.0F, -2.5F, -2.5F, 4.0F, 4.0F, 5.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-4.0F, 2.5F, 1.5F, 1.5708F, 0.0F, 0.0F));

		PartDefinition tail2 = partdefinition.addOrReplaceChild("tail2",
				CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, 0.0F, 9.0F, 4.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 27.0F, 16.0F, 1.4399F, 0.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(50, 56)
				.addBox(-1.0F, -10.0F, 13.0F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),

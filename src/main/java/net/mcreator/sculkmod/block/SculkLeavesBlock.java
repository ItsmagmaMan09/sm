...
public class SculkLeavesBlock extends Block {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(SculkModModBlocks.SCULK_LEAVES.get(), renderType -> renderType == RenderType.cutout());
	}
}

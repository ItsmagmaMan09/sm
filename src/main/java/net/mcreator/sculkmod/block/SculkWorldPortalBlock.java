...
import net.mcreator.sculkmod.world.teleporter.SculkWorldTeleporter;
import net.mcreator.sculkmod.world.teleporter.SculkWorldPortalShape;

import java.util.Random;
import java.util.Optional;

public class SculkWorldPortalBlock extends NetherPortalBlock {
	public SculkWorldPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<SculkWorldPortalShape> optional = SculkWorldPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new SculkWorldPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			...
			} else if (entity.level.dimension() != ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("sculk_mod:sculk_world"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("sculk_mod:sculk_world")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new SculkWorldTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}

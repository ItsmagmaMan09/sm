...
import net.mcreator.sculkmod.entity.SculkWalkerEntity;
...
public class SculkModModEntities {
	...
	public static final RegistryObject<EntityType<SculkWalkerEntity>> SCULK_WALKER = register("sculk_walker",
			EntityType.Builder.<SculkWalkerEntity>of(SculkWalkerEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true)
					.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(SculkWalkerEntity::new).fireImmune().sized(0.6f, 1.8f));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(SCULK_WALKER.get(), SculkWalkerEntity.createAttributes().build());
	}
}

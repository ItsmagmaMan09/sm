...
package net.mcreator.sculkmod.world.dimension;
...
public class SculkWorldDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("sculk_mod:sculk_world"), customEffect));
		}
	}
}

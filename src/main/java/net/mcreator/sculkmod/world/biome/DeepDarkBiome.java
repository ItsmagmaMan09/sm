...
public class DeepDarkBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT_UNDERGROUND = new Climate.ParameterPoint(Climate.Parameter.span(-1, 1),
			...
			Climate.Parameter.span(0.2f, 0.9f), Climate.Parameter.span(-1.631362558707f, 0.368637441293f), 0);
	...
	public static Biome createBiome() {
		...
		mobSpawnInfo.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(SculkModModEntities.CHEAP_WARDEN.get(), 20, 4, 4));

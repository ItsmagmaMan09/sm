...
package net.mcreator.sculkmod.world.features.plants;
...
public class SculkLightFeature extends RandomPatchFeature {
	public static SculkLightFeature FEATURE = null;
